...
public static class MathUtility
{
    ...
    /// <summary>
    /// Remaps value within range [a,b] to range [x,y] proportionally
    /// </summary>
    /// <param name="value">initial value</param>
    /// <param name="a">current range start</param>
    /// <param name="b">current range end</param>
    /// <param name="x">new range start</param>
    /// <param name="y">new range end</param>
    /// <returns>value in new range [x,y]</returns>
